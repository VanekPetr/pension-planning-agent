# Contributing to pension-planning-agent

This document is a guide to contributing to pension-planning-agent
...
## Building pension-planning-agent from source

You'll need to build pension-planning-agent locally in order to start editing code.

To install pension-planning-agent from source, clone the GitHub
...
To contribute to pension-planning-agent, send us pull requests.
For those new to contributing, check out GitHub's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the pension-planning-agent
...
If you'd like to add a new feature to pension-planning-agent, please do propose your
...
- Read the pension-planning-agent source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/VanekPetr/pension-planning-agent/issues),
...
pension-planning-agent tests live in the directory `tests`,
